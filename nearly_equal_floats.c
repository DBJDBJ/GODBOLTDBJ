 ...
 *
 *  2022 NOV 16 dbj@dbj.org -- Refactoring
...
***********************************************************************************
*/
// The trick is to find the right epsilon, FLT_EPSILON seems not to work as
// expected. this makes almost all tests fail #define DBJ_EPSILON 0.001f this
// one makes 7, 11 and 12 fail
#define DBJ_EPSILON 0.00001f
// this makes almost all tests fail
// #define DBJ_EPSILON 0.0000001f

__inline bool
nearly_equal_proxy(float a, float b) {
